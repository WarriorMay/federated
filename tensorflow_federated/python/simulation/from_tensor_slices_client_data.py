...
class FromTensorSlicesClientData(client_data.ClientData):
  ...
  def __init__(self, tensor_slices_dict):
    ...
    if isinstance(example_value, dict):
      ...
      # This is needed to keep data that was loosely specified in a list
      # together in a common object (a tf.Tensor or tf.RaggedTensor), for
      # correct flattening.
